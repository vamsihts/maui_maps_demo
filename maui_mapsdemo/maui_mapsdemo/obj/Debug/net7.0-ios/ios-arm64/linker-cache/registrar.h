...
@class AppDelegate;
@class maui_mapsdemo_CustomAnnotation;
@class maui_mapsdemo_CustomMKAnnotationView;
...
@interface maui_mapsdemo_CustomAnnotation : MKPointAnnotation {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
...
@interface maui_mapsdemo_CustomMKAnnotationView : MKAnnotationView {
}
	-(void) release;
	-(id) retain;
	-(GCHandle) xamarinGetGCHandle;
